...
public class WaterSplashParticle extends SpriteBillboardParticle {
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTicks) {
        ...
        float height = size * 1.5f; // Make splash taller than it is wide
    ...
    private void renderVerticalWall(VertexConsumer buffer, float centerX, float centerY, float centerZ,
        ...
        // Render the vertical wall quad with proper winding order
        if (!reversed) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientWorld world,
            ...
            return new WaterSplashParticle(world, x, y, z, spriteProvider, velocityX);
        }
    }
}